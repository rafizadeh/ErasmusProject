...
namespace ErasmusApp.Areas.Admin.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Description,DesignedDescription,DesignedTitle,ShortDesc")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Description,DesignedDescription,DesignedTitle,ShortDesc")] About about)
        {
            if (ModelState.IsValid)
            {
